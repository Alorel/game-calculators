(function () {
    var $maxHP = $("#_hpt-hpmax"),
        ...
        recalculate = function () {
            ...
            $autodrinkL.text(Math.roundToTwo((maxHP - healL) / maxHP * 100) + "%").attr("data-original-title", (maxHP - healL).format() + " HP");
            $autodrinkM.text(Math.roundToTwo((maxHP - healM) / maxHP * 100) + "%").attr("data-original-title", (maxHP - healM).format() + " HP");
